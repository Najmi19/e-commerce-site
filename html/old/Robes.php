<?php
    ...
    $statement = $db->query('SELECT * 
                        FROM articles a LEFT JOIN typesdarticle ta ON a.categorie like ta.type_article WHERE a.categorie like \'robe\'
            ...
            <tbody>
                <?php
                    while($item = $statement->fetch()){
                        echo '<tr>';
                        echo '<td ><img src="../'.$item['illustration'].'"width=40px height=40px></td>';
